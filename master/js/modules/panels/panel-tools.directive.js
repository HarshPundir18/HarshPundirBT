...
(function() {
    ...
    paneltool.$inject = ['$compile', '$timeout', 'translationService'];
    function paneltool ($compile, $timeout, translationService) {
        var directive = {
            link: link,
            restrict: 'E',
            scope: false
        ...
        function link(scope, element, attrs) {
          var templates = {
            ...
            collapse:'<a href="#" panel-collapse="" uib-tooltip="' + translationService.translate('collapse_button') + '" ng-click="{{panelId}} = !{{panelId}}"> \
