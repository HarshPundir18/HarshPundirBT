...
(function() {
    ...
    angular
        ...
        ProductsListController.$inject = ['$scope', '$compile', '$state', 'DTDefaultOptions', 'DTOptionsBuilder', 'DTColumnBuilder', 
        'translationService', 'spinnerService', 'productCodesService', 'utilsService', 'ngDialog'];
    function ProductsListController($scope, $compile, $state, DTDefaultOptions, DTOptionsBuilder, DTColumnBuilder, 
        translationService, spinnerService, productCodesService, utilsService, ngDialog) {
        let vm = this;
        vm.dtInstance = {};
        vm.pageSize = 10;
        ...
        function activate() {
            ...
            vm.dtColumns = [
                ...
                DTColumnBuilder.newColumn('description', 'Designação')
                    ...
                    .withClass('sorting_disabled')
                    .withClass('dt-center'),
                DTColumnBuilder.newColumn('groupInternalCode', 'Grupo')
                    .notSortable()
                    .withClass('sorting_disabled')
                    .withClass('dt-center'),
                DTColumnBuilder
        ...
        function getData(dataTable, callback, settings) {
            ...
            productCodesService.getPage(dataTable.start, dataTable.length, dataTable.search.value)
                    ...
                    if (result) {
                        ...
                        var items = result.data.aaData.map(function(item) {
                            return { 
                                ...
                                groupInternalCode: item.GroupInternalCode
                            };
                        });
        ...
        vm.editActionClick = function(uniqueId){
            $state.go('app.productsEdit', {id: uniqueId})
        }
