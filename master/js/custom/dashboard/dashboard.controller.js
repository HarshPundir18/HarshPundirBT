(function() {
    ...
    dashboardController.$inject = ['$scope', '$q', '$log', 'ChartData', '$timeout', '$state',
                                    'oauthService', 'establishmentService', 'dummyService'];
    function dashboardController($scope, $q, $log, ChartData, $timeout, $state,
                                    oauthService, establishmentService, dummyService) {
        var vm = this;

        vm.hasDefaultEstablishment = null;
        vm.WELCOME = "Yeahhhhh ZEEE"
