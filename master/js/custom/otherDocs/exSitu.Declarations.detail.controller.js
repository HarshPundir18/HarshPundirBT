...
(function() {
    ...
    angular
        .module('custom')
        .controller('generatedDocumentsDetailController', generatedDocumentsDetailController);

    generatedDocumentsDetailController.$inject = ['$state', '$scope', '$compile', '$timeout', '$stateParams',
    ...
    function generatedDocumentsDetailController($state, $scope, $compile, $timeout, $stateParams,
        spinnerService, egarBatchService, translationService, otherDocsService, browserService,
        DTDefaultOptions, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
