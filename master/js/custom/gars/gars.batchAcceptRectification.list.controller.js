...
(function() {
    ...
    angular
        .module('custom')
        .controller('garsBatchAcceptRectificationListController', garsBatchAcceptRectificationListController);

        garsBatchAcceptRectificationListController.$inject = ['$state', '$scope', '$compile',
    'spinnerService', 'egarBatchService', 'translationService',
    'DTDefaultOptions', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder'];
    function garsBatchAcceptRectificationListController($state, $scope, $compile,
        spinnerService, egarBatchService, translationService,
        DTDefaultOptions, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
