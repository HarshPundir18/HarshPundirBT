(function () {
  ...
  function collectionController(
    ...
    function getEquipments() {
      ...
      collectionService.getDeliveredEquipments().then(function (result) {
    ...
    vm.submitForm = function () {
      ...
      if (
        ...
        !this.shouldShowEquipmentSelecterError()
      ) {
        var data = {};
        ...
        collectionService
          .create(data)
          .then(createCollectionOnSuccess, createCollectionOnError)
    ...
    function createCollectionOnSuccess(result) {
      $state.go("app.dashboard");
    ...
    function createCollectionOnError(error, status) {
    ...
    vm.shouldShowEquipmentSelecterError = function () {
      var result =
        vm.submitted &&
        (vm.equipmentsIds == null ||
          vm.equipmentsIds == undefined ||
          vm.equipmentsIds == []);
      return result;
    };
